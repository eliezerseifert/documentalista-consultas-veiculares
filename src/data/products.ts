...
export const productsData: Product[] = [
  {
    ...
    features: [
      ...
      { name: 'Laudo CSV & Inspeção (SISCSV)', description: 'Certificado de Segurança Veicular Denatran e testes de frenagem/suspensão.', included: true, highlight: true },
      { name: 'Ações Trabalhistas & Processos (CNDT)', description: 'Certidão Negativa de Débitos Trabalhistas e processos judiciais.', included: true, highlight: true },
      { name: 'Checklist de Histórico de Uso', description: 'Histórico de viatura policial, táxi, locadora, guincho e frotas.', included: true },
      { name: 'Dados do Proprietário (CPF/CNPJ)', description: 'Nome/Razão Social e CPF/CNPJ do proprietário cadastrado.', included: true },
      { name: 'RENAINF & Infrações de Trânsito', description: 'Registro Nacional de Infrações de Trânsito.', included: true },
      { name: 'Indício de Busca e Apreensão', description: 'Alerta de risco de retomada por financeira.', included: true },
      { name: 'Equipamentos de série e opcionais', description: 'Lista completa de itens de série, conforto e segurança.', included: true },
      ...
      { name: 'Ficha Técnica Completa', description: 'Especificações mecânicas, potência, consumo e medidas.', included: true },
      ...
      { name: 'Restrições e impedimentos', description: 'Restrições administrativas e de transferência.', included: true },
      { name: 'Risco de comercialização', description: 'Pontuação de liquidez e aceitação no mercado de seminovos.', included: true },
      { name: 'Score de leilão completo', description: 'Nota de impacto e desvalorização no leilão.', included: true }
    ],
    sampleReport: {
